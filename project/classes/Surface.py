class Surface:
    def __init__(self, row: int, col: int, theta_dep: int, average_height: int = 0, total_particle: int = 0, max_height: int = 0) -> None:
    ...
    def set_total_particle(self) -> None:
        self.total_particle = self.get_total_particle() + self.theta_dep
